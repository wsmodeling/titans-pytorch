...
if MEMORY_TYPE == 'kda':
    ...
    neural_memory_model = create_sparse_kda_memory_for_mac(
        ...
        use_oracle_router = SPARSE_KDA_USE_ORACLE_ROUTER,
        use_lsh_write = SPARSE_KDA_USE_LSH_WRITE,
    )
